...
import com.example.xmall.product.service.AttrAttrgroupRelationService;
import com.example.xmall.product.service.AttrService;
...
import com.example.xmall.product.service.AttrGroupService;
...
public class AttrGroupController {
     ...
     * 列表
     */
    @RequestMapping("/list/{catelogLd}")
    public R list(@RequestParam Map<String, Object> params,
                  @PathVariable("catelogLd") Long catelogId) {
